        ...
        _c(
                          ...
                          [
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    _c("i", {
                                      staticClass:
                                        "fa fa-square text-info fa-stack-2x"
                                    }),
                                    _vm._v(" "),
                                    _c("i", {
                                      staticClass:
                                        "fas fa-eye fa-stack-1x text-white"
                                    })
                                  ]
                                )
                              ]
                            ...
                            _c(
                              "span",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.deletePost(row.id_akun)
                                  }
                                }
                              },
                              [
          ...
          [
            _c(
              ...
              [
                _c("v-th", { attrs: { sortKey: "npwp" } }, [_vm._v("NPWP")]),
                _vm._v(" "),
                _c("v-th", { attrs: { sortKey: "name" } }, [_vm._v("Name")]),
                _vm._v(" "),
                _c("v-th", { attrs: { sortKey: "last_login" } }, [
                  _vm._v("Last Login")
                ]),
                _vm._v(" "),
                _c("th", [_vm._v("Action")])
