    ...
    return {
      datacollection: {
        ...
        datasets: [{
          ...
          label: 'Data Two',
          backgroundColor: '#f87238',
          data: [4, 5]
        }]
      },
      dataBar: {
        labels: ['January', 'Bulan Naon we'],
        datasets: [{
          label: 'Data One',
          backgroundColor: '#f87979',
          data: [7, 4]
    ...
    _c("div", { staticClass: "row mt-5" }, [
      ...
      _c("div", { staticClass: "col-md-4 " }, [
        _c(
          "div",
          { staticClass: "bg-white p-4 rounded-lg" },
          [_c("bar-chart", { attrs: { "chart-data": _vm.dataBar } })],
          1
        )
      ]),
      _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "row mt-4" }, [
      _c("div", { staticClass: "col-md-4 " }, [
        _c("div", { staticClass: "bg-white p-4 rounded-lg" }, [
          _c("span", { staticClass: "fa-stack fa-lg float-left" }, [
            _c("i", { staticClass: "fa fa-circle text-danger fa-stack-2x" }),
            _vm._v(" "),
            _c("i", {
          ...
          _vm._v(" "),
          _c("p", { staticClass: "float-center" }, [_vm._v("125 Notification")])
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "col-md-4 " }, [
        _c("div", { staticClass: "bg-white p-4 rounded-lg" }, [
          _c("span", { staticClass: "fa-stack fa-lg float-left" }, [
            _c("i", { staticClass: "fa fa-circle text-info fa-stack-2x" }),
            _vm._v(" "),
            _c("i", { staticClass: "fas fa-users fa-stack-1x text-white" })
          ]),
          _vm._v(" "),
          _c("p", { staticClass: "float-center" }, [_vm._v("20 Employee")])
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "col-md-4 " }, [
        _c("div", { staticClass: "bg-white p-4 rounded-lg" }, [
          _c("span", { staticClass: "fa-stack fa-lg float-left" }, [
            _c("i", { staticClass: "fa fa-circle text-primary fa-stack-2x" }),
            _vm._v(" "),
            _c("i", { staticClass: "fas fa-tasks fa-stack-1x text-white" })
          ]),
          _vm._v(" "),
          _c("p", { staticClass: "float-center" }, [_vm._v("12 Task")])
        ])
      ])
    ])
  }
