...
/* harmony import */ var _event_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./event-utils */ "./resources/js/components/admin/event-utils.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      calendarOptions: {
        plugins: [_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_3__["default"], _fullcalendar_bootstrap__WEBPACK_IMPORTED_MODULE_2__["default"], _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_4__["default"]],
  ...
  methods: {
    addEventClick: function addEventClick(info) {
      ...
      _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var _yield$_this2$$swal$f, text, calendarApi;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _yield$_this2$$swal$f = _context.sent;
                text = _yield$_this2$$swal$f.value;
                _context.next = 6;
                return info.view.calendar;

              case 6:
                calendarApi = _context.sent;
                calendarApi.unselect(); // clear date selection

                if (text) {
                  calendarApi.addEvent({
                    id: Object(_event_utils__WEBPACK_IMPORTED_MODULE_5__["createEventId"])(),
                    title: text,
                    start: info.startStr,
                    end: info.endStr,
                    allDay: info.allDay
